...
<section className="py-20 bg-white">
  <div className="container mx-auto px-4 text-center mb-16">
    ...
    <p className="text-lg md:text-xl max-w-2xl mx-auto text-gray-500">
      Meet the passionate leaders who drive TechVerse forward with innovation,
      teamwork, and vision.
    </p>
  </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-28 gap-y-12 justify-items-center">
      {leaders.slice(0, 6).map((member, index) => (
        ...
        >
          <div
            className={`relative w-full h-full transition-transform duration-[8000ms] ease-[cubic-bezier(0.45,0.05,0.55,0.95)] [transform-style:preserve-3d] ${
              flippedIndex === index + 200 ? "[transform:rotateY(180deg)]" : ""
            }`}
          >
            {/* Front Side */}
            <Card className="absolute inset-0 flex flex-col justify-center items-center p-6 border border-blue-200 shadow-lg rounded-xl bg-white [backface-visibility:hidden] transition-transform duration-500 hover:scale-105 hover:shadow-blue-200/70">
    ...
    <div className="flex justify-center mt-16">
      {leaders.slice(6, 7).map((member, index) => (
        ...
        >
          <div
            className={`relative w-full h-full transition-transform duration-[8000ms] ease-[cubic-bezier(0.45,0.05,0.55,0.95)] [transform-style:preserve-3d] ${
              flippedIndex === index + 300 ? "[transform:rotateY(180deg)]" : ""
            }`}
          >
            {/* Front Side */}
            <Card className="absolute inset-0 flex flex-col justify-center items-center p-6 border border-blue-200 shadow-lg rounded-xl bg-white [backface-visibility:hidden] transition-transform duration-500 hover:scale-105 hover:shadow-blue-200/70">
...
<div className="relative w-full flex justify-center items-center -mt-10">
  ...
  >
    ...
    <path d="M50 80 L750 80" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    {/* small verticals to each member */}
    <path d="M150 80 L150 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    <path d="M316 80 L316 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    <path d="M484 80 L484 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    <path d="M650 80 L650 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    ...
    />
    <defs>
      <linearGradient id="glowGradient" x1="150" y1="80" x2="650" y2="80" gradientUnits="userSpaceOnUse">
...
<div className="relative flex justify-center gap-x-12 mt-12 flex-wrap md:flex-nowrap">
  ...
  {leaders.slice(7, 11).map((member, index) => {
    ...
    const lift = index === 0 || index === 3 ? "-translate-y-32" : index === 1 || index === 2 ? "-translate-y-4" : "";
    ...
    return (
      ...
      >
        <div
          className={`relative w-full h-full transition-transform duration-[8000ms] ease-[cubic-bezier(0.45,0.05,0.55,0.95)] [transform-style:preserve-3d] ${
            flippedIndex === index + 400 ? "[transform:rotateY(180deg)]" : ""
          }`}
        >
          {/* Front Side */}
          <Card className="absolute inset-0 flex flex-col justify-center items-center p-6 border border-blue-200 shadow-lg rounded-xl bg-white [backface-visibility:hidden] transition-transform duration-500 hover:scale-105 hover:shadow-blue-200/70">
  ...
  <div className="flex justify-center relative z-10">
    {leaders.slice(11, 12).map((member, index) => (
      ...
      >
        <div
          className={`relative w-full h-full transition-transform duration-[8000ms] ease-[cubic-bezier(0.45,0.05,0.55,0.95)] [transform-style:preserve-3d] ${
            flippedIndex === index + 500 ? "[transform:rotateY(180deg)]" : ""
          }`}
        >
          {/* Front Side */}
          <Card className="absolute inset-0 flex flex-col justify-center items-center p-6 border border-blue-200 shadow-lg rounded-xl bg-white [backface-visibility:hidden] transition-transform duration-500 hover:scale-105 hover:shadow-blue-200/70">
...
<div className="relative w-full flex justify-center items-center -mt-10">
  ...
  >
    ...
    <path d="M400 0 L400 80" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    {/* horizontal connector */}
    <path d="M-100 80 L900 80" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    {/* small verticals to each member */}
    <path d="M150 80 L150 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    <path d="M316 80 L316 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    <path d="M484 80 L484 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    ...
    {leaders.slice(12, 17).map((member, index) => {
      ...
      return (
        ...
        >
          <div
            className={`relative w-full h-full transition-transform duration-[8000ms] ease-[cubic-bezier(0.45,0.05,0.55,0.95)] [transform-style:preserve-3d] ${
              flippedIndex === index + 600 ? '[transform:rotateY(180deg)]' : ''
            }`}
          >
            {/* Front Side */}
...
<div className="flex justify-center mt-24 relative z-10">
  {leaders.slice(17, 18).map((member, index) => (
    ...
    >
      <div
        className={`relative w-full h-full transition-transform duration-[8000ms] ease-[cubic-bezier(0.45,0.05,0.55,0.95)] [transform-style:preserve-3d] ${
          flippedIndex === index + 700 ? "[transform:rotateY(180deg)]" : ""
        }`}
      >
        {/* Front Side */}
        <Card className="absolute inset-0 flex flex-col justify-center items-center p-6 border border-blue-200 shadow-lg rounded-xl bg-white [backface-visibility:hidden] transition-transform duration-500 hover:scale-105 hover:shadow-blue-200/70">
...
<div className="relative w-full flex justify-center items-center -mt-14">
  ...
  >
    ...
    <path d="M450 0 L450 80" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    {/* horizontal line */}
    <path d="M80 80 L820 80" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    {/* small vertical connectors */}
    <path d="M200 80 L200 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    <path d="M390 80 L390 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    <path d="M510 80 L510 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
    <path d="M700 80 L700 100" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
  </svg>
</div>
  ...
  {leaders.slice(18, 22).map((member, index) => {
    ...
    return (
      ...
      >
        <div
          className={`relative w-full h-full transition-transform duration-[8000ms] ease-[cubic-bezier(0.45,0.05,0.55,0.95)] [transform-style:preserve-3d] ${
            flippedIndex === index + 800 ? "[transform:rotateY(180deg)]" : ""
          }`}
        >
          {/* Front */}
          <Card className="absolute inset-0 flex flex-col justify-center items-center p-5 border border-blue-200 shadow-lg rounded-xl bg-white [backface-visibility:hidden] transition-transform duration-500 hover:scale-105 hover:shadow-blue-200/70">
